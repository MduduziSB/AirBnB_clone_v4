$(document).ready(function () {
  ...
  $('input:checkbox').change(function () {
    ...
    const type = checkbox.parents('li').attr('data-type');
    ...
    const selectedLocations = Object.values(states).concat(Object.values(cities));
  ...
  function searchPlaces() {
    $.ajax({
      ...
      data: JSON.stringify({ amenities: amenities, states: Object.keys(states), cities: Object.keys(cities) }),
